 ...
 */
final class Version20250419161643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE school ADD owner_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_F99EDABB7E3C61F9
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE school DROP owner_id
        SQL);
    }
}
